...
print(col1.shape) #(채널 수*필터높이*필터너비=75로 col2와 동일)

x2 = np.random.rand(10,3,7,7) #데이터의 수, 채널 수, 높이, 너비
col2 = im2col(x2,5,5,stride=1,pad=0)
print(col2.shape) #(데이터의 수가 10개로 늘어나 9에서 90으로 바뀜)
...
class Convolution:
    ...
    def forward(self, x):
        ...
        col_W = self.W.reshape(FN,-1).T  #전치 행렬 사용 ,-1은 다차원 배열의 원소 수가 변환 후에도 적절히 유지되도록 하는 역할
